...
beautiful.font = "FantasqueSansMono Nerd Font 12"
...
myawesomemenu = {
   ...
   { "suspend", function() awful.spawn.with_shell("sleep 1 && systemctl suspend") end }
}
...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey, }, "r", function () awesome.restart() end,
