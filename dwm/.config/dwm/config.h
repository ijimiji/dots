...
/* commands */
static const char *dmenumon[] = {"0", NULL };
static const char *screenshot[] = {"bash", "/home/jahor/.config/dwm/bin/screenshot.sh", NULL};
static const char *dmenucmd[] = { "bash", "/home/jahor/.config/dwm/bin/runner.sh", NULL };
static const char *termcmd[]  = { "xterm", NULL };
static const char *power[] = {"bash", "/home/jahor/.config/dwm/bin/power.sh", NULL};

static Key keys[] = {
	/* modifier                     key        function        argument */
//	{ MODKEY,                       XK_space,  spawn,          {.v = dmenucmd } },
//	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
//	{ MODKEY,                       XK_r,      spawn,          {.v = screenshot} },
//	{ MODKEY,                       XK_q,      spawn,          {.v = power} },
	{ MODKEY,                       XK_q,      changeTheme,    {0} },
